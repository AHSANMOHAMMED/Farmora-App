...
class FarmoraState extends ChangeNotifier {
  ...
  Future<bool> placeOrder({
    ...
    if (_currentUserId.isNotEmpty &&
        (transporterId == null || transporterId.isEmpty)) {
      return false;
    }
  ...
  Future<void> initFromFirestore(String uid) async {
    ...
    _productsSub?.cancel();
    // Demo products are initialized for signed-out/offline screens. Once a
    // user profile is loaded, the list must be owned by Firestore.
    _products.clear();
    notifyListeners();
